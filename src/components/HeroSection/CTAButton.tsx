  ...
  return (
    <div className="text-lg font-light items-center box-border caret-transparent gap-x-4 flex justify-center leading-7 gap-y-4 md:font-semibold md:justify-start">
      <Link
        ...
        className="text-black font-light items-center bg-green-500 box-border caret-transparent gap-x-2 flex justify-center gap-y-2 w-40 md:w-52 border py-[11px] rounded-xl border-solid border-white/10 md:font-semibold hover:border-green-500"
      >
        <Image
          width={30}
          height={30}
      ...
      <Link
        href="mailto://dev.mostafiz4372@gmail.com"
        className="font-light items-center bg-neutral-900 box-border caret-transparent gap-x-2 flex justify-center gap-y-2 w-40 md:w-52 border py-[11px] rounded-xl border-solid border-white/10 md:font-semibold hover:text-green-500 hover:border-green-500"
      >
        <Image
          width={30}
          height={30}
